...
const Index = () => {
   ...
   const fetchCustomers = async ({ queryKey }) => {
      ...
      const response = await axios.get(`${API_URL}/api/customer_banned`, {
         params: {
            page,
            lastname: query,
            sortColumn,
                        ...
                        <tr>
                           ...
                           >
                              <div className="flex justify-center items-center gap-2">
                                 No customer banned records found
