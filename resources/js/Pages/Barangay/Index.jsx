...
const Index = () => {
   ...
   const TABLE_ROWS =
      data?.data.map((barangays) => ({
         id: barangays.id,
         purok_name: barangays.purok_name,
         barangay_name: barangays.barangay_name,
         municipality_name: barangays.municipality.municipality_name,
         barangay_munipalities:
            toCamelCase(barangays.municipality.municipality_name) +
            ", " +
            toCamelCase(barangays.barangay_name),
      })) || [];
